...
class SearchFilterForm(FlaskForm):
    ...
    birth_year_min = IntegerField("Birth Year Min", validators=[Optional()])
    birth_year_max = IntegerField("Birth Year Max", validators=[Optional()])
    dob_from = DateField("Date of Birth From", validators=[Optional()])
    dob_to = DateField("Date of Birth To", validators=[Optional()])
    height_min = IntegerField("Height Min (cm)", validators=[Optional()])
    height_max = IntegerField("Height Max (cm)", validators=[Optional()])
    weight_min = IntegerField("Weight Min (kg)", validators=[Optional()])
    weight_max = IntegerField("Weight Max (kg)", validators=[Optional()])
    ...
    occupation = StringField("Occupation / Profession", validators=[Optional()])
    company_business = StringField("Company / Business", validators=[Optional()])
    income_min = IntegerField("Annual Income Min (₹)", validators=[Optional()])
    income_max = IntegerField("Annual Income Max (₹)", validators=[Optional()])
    blood_group = SelectField("Blood Group", choices=[
        ("", "Any"), ("A+", "A+"), ("A-", "A-"), ("B+", "B+"), ("B-", "B-"),
        ("AB+", "AB+"), ("AB-", "AB-"), ("O+", "O+"), ("O-", "O-")])
    complexion = SelectField("Complexion", choices=[
        ("", "Any"), ("Fair", "Fair"), ("Wheatish", "Wheatish"), ("Dark", "Dark")])
    body_type = SelectField("Body Type", choices=[
        ("", "Any"), ("Slim", "Slim"), ("Athletic", "Athletic"), ("Average", "Average"), ("Heavy", "Heavy")])
    ...
    children = SelectField("Children", choices=[("", "Any"), ("0", "None"), ("1+", "One or more")])
    smoking = SelectField("Smoking", choices=[("", "Any")] + YESNO)
    drinking = SelectField("Drinking", choices=[("", "Any")] + YESNO)
    manglik = SelectField("Manglik", choices=[("", "Any")] + MANGLIK_CHOICES)
    rashi = StringField("Rashi", validators=[Optional()])
    nakshatra = StringField("Nakshatra", validators=[Optional()])
    mulank = IntegerField("Mulank", validators=[Optional()])
    ...
    verified = SelectField("Verified", choices=[("", "Any"), ("yes", "Yes"), ("no", "No")])
